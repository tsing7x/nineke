...
OperationButton.BUTTON_WIDTH = 160
OperationButton.BUTTON_HEIGHT = 56
...
function OperationButton:ctor(suffix)
    ...
    self.backgrounds_ = {
        oprUp = display.newScale9Sprite("#common_btn_"..suffix.."_normal.png"):size(btnW, btnH):addTo(self),
        oprDown = display.newScale9Sprite("#common_btn_"..suffix.."_pressed.png"):size(btnW, btnH):addTo(self),
        checkUp = display.newScale9Sprite("#pdeng_room_opr_check_up.png"):size(btnW, btnH):addTo(self),
        checkDown = display.newScale9Sprite("#pdeng_room_opr_check_down.png"):size(btnW, btnH):addTo(self),
    ...
    self.iconCheckIcon_ = display.newSprite("#pdeng_room_opr_check_normal.png"):pos(OperationButton.BUTTON_WIDTH * -0.5 + 20, 0):addTo(self)
...
function OperationButton:updateView_()
    if self.isCheckMode_ then
        ...
        if self.isChecked_ then
            self.iconCheckIcon_:setSpriteFrame(display.newSpriteFrame("pdeng_room_opr_check_checked.png"))
        else
            self.iconCheckIcon_:setSpriteFrame(display.newSpriteFrame("pdeng_room_opr_check_normal.png"))
        end
