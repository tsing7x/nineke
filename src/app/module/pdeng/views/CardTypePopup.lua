...
CardTypePopup.WIDTH = 540
CardTypePopup.HEIGHT = 640

function CardTypePopup:ctor()
    self.content_ = display.newSprite("pdeng_card_type.png"):addTo(self)
    self.content_:setTouchEnabled(true)
    self.content_:setTouchSwallowEnabled(true)
    self:pos(-CardTypePopup.WIDTH * 0.5, CardTypePopup.HEIGHT * 0.5)
end
