...
function LampManager:turnTo(positionId, animation)
    ...
    if seatPos.x == RoomViewPosition.SelfSeatPosition[2].x then
        seatPos = RoomViewPosition.SelfSeatPosition[1]
    end
    ...
    if lampPosX > seatPosX then
        ...
        if angleH <= 0 and seatPosY < lampPosY then
            angleH = angleH + 180
        end
    end
